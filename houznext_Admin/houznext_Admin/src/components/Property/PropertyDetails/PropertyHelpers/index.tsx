import { Apartment, Store, MapOutlined, Business, LocalLaundryService, Weekend, Microwave, Water, GasMeter, Tv, KingBed, Countertops, NaturePeopleOutlined, House, CameraAlt, FitnessCenter, Yard, Pool, LocalBar, ChildCare, MeetingRoom, LocalParking, LocalFireDepartment, ElectricalServices, SoupKitchen } from '@mui/icons-material';
import {
    Security,
    BatteryChargingFull,
    Chair,
...
export enum propertyTypeEnum {
  ...
  Villa = "Villa",
  Plot = "Plot",
  AgriculturalLand = "Agriculture Land",
}
...
export const roomTypes: string[] = ["livingRoom", "kitchen", "bedroom", "bathroom", "dining"];
...
export const iconMap: Record<string, JSX.Element> = {
  ...
  MaxSize: <ArrowUp />,
  minPrice: <ArrowDown />,
  promotionType: <BadgePercent />,
  maxPrice: <ArrowUp />,
  Specifications: <AlignLeft />,
  Brochure: <FileDown />,
  propertyType: <Building2 />,
  AboutProject: <Info />,
  ProjectAmenities: <Star />,
  location: <MapPin />,
  mediaDetails: <Image />,
  ...
  status: <Construction />,
  ageOfProperty: <Clock />,
  possessionYears: <CalendarClock />,
  possessionBy: <CalendarDays />,

  typeName: <Building2 />,
  description: <FileText />,
  additionalAttributes: <ListTree />,
  units: <ListTree />,
