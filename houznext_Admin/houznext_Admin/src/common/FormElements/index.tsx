...
import CustomCheckbox,{ICustomICheckProps} from './CheckBoxInput'
...
export interface CustomFormOtherProps {
  ...
  topHeader?: ReactNode,
  footer?: ReactNode,
  inputArr?: Array<ICustomInputProps | ISingleSelectProps | IMultiSelectProps | ICustomICheckProps | RichTextEditorProps | FileInputProps | ImageUploaderProps>
  btns?: Array<any>
  btnsCls?: string
}
  ...
  const renderComponent = (element: any, key: string) => {
    if (element && element.type) {
      switch (element.type) {
        ...
        case "checkbox": {
          const { ref, ...otherCheckBoxProps } = element as ICustomICheckProps;
          return <CustomCheckbox key={key} {...otherCheckBoxProps} />;
        }
        case "richtext": {
        ...
        case "images": {
          ...
          return <ImageUploader key={key} {...props} />;
        }
        default: {
          if (
            element.type == "text" ||
