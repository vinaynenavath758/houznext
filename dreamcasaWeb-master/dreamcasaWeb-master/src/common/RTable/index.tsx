...
const RTable = ({
      ...
      header: ({ table }) => (
        <IndeterminateCheckbox
          {...{
            ...
            className: "cursor-pointer rounded-[2px] border-2 border-gray-500",
          }}
        />
      ),
      cell: ({ row }) => (
  ...
  const handleEditRow = (rowData: any, rowIndex: number) => {
    ...
    console.log("handleEditRow", rowData, rowIndex);
    if (handleEdit) {
            ...
            <tr key={row.id} className={twMerge(styles.trbody, trBodyClassName)}>
              ...
              <td className="text-center">
                <button
                  ...
                  className="text-[#3586FF] hover:text-[#3586FF] cursor-pointer"
                >
                  <FaEdit />
                </button>
              </td>
